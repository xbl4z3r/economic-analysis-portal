...
export default function Home() {
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-linear-to-br from-slate-900 via-blue-900 to-slate-900 py-24 sm:py-32">
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-20">
          <div className="absolute inset-0 bg-[linear-gradient(to_right,#1e3a5f_1px,transparent_1px),linear-gradient(to_bottom,#1e3a5f_1px,transparent_1px)] bg-size-[4rem_4rem]" />
        </div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            {/* Description */}
            <p className="mb-10 text-lg leading-8 text-slate-300 sm:text-xl">
          ...
          <div className="mx-auto mt-16 grid max-w-4xl grid-cols-1 gap-6 sm:grid-cols-3">
            ...
            <div className="rounded-2xl border border-slate-700 bg-slate-800/50 p-6 text-center backdrop-blur-sm">
              <div className="text-4xl font-bold text-amber-400">21%</div>
              <div className="mt-2 text-sm text-slate-400">
                TVA propus (creștere)
              </div>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/50 p-6 text-center backdrop-blur-sm">
              <div className="text-4xl font-bold text-red-400">2T</div>
              <div className="mt-2 text-sm text-slate-400">
